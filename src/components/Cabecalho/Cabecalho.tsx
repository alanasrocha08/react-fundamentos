...
export default function Cabecalho() {
  /* Aqui definimos a chamada de uma função especial do React: useStates. Esta e outras funções iniciadas com o prefixo 'use' são conhecisas como React Hooks.
  ...
  const alternarTitulo = () => {
    setTitulo("Experiemntando States!");
  };
